...
import Restaurant from './app/modules/restaurant/restaurant.model.js';
import Booking from './app/modules/booking/booking.model.js';
import bcrypt from 'bcryptjs';
import { UserRole } from './app/modules/user/user.interface.js';
import { RestaurantStatus } from './app/modules/restaurant/restaurant.interface.js';
...
const seedData = async () => {
    try {
        ...
        const updatedREstaurantsData = restaurantData.map((rest, index) => {
            const { ...restInfo } = rest;
            return {
                ...restInfo,
                owner: ownerUser._id,
